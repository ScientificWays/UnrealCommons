...
#include "ATAASC_Base.generated.h"
...
UDELEGATE()
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FComboMoveEventSignature, class UComboMoveData*, InComboMoveData);

/**
 * 
 */
UCLASS(Abstract, Blueprintable)
class ATA_DREAMCOMETRUE_API UATAASC_Base : public UAbilitySystemComponent
{
	GENERATED_BODY()
...
public:
	...
	static UATAASC_Base* TryGetBaseAtaASCFromActor(const AActor* InActor, bool bInTryFindComponentIfNoInterface = true);
//~ End Statics
...
protected:
	...
	UPROPERTY(Category = "Attributes", EditDefaultsOnly, BlueprintReadOnly)
	TSubclassOf<class UATAAS_Base> AttributeSetClass;
...
private:
	...
	UPROPERTY()
	TObjectPtr<const UATAAS_Base> BaseAS;
//~ End Attributes
...
public:
	...
	void QueueComboMove(class UComboMoveData* InComboMoveData);
	...
	void AddComboMove(class UComboMoveData* InComboMoveData, bool InUpdateRelevantCombo = true, bool InResetIfNoRelevantCombo = true);
	...
	UPROPERTY(Category = "Combo", BlueprintReadOnly)
	TObjectPtr<class UComboMoveData> QueuedComboMove;

	UPROPERTY(Category = "Combo", EditDefaultsOnly, BlueprintReadOnly)
	TArray<TObjectPtr<class UComboMoveData>> CurrentComboMoves;

	UPROPERTY(Category = "Combo", EditDefaultsOnly, BlueprintReadOnly)
	TArray<TObjectPtr<class UComboData>> AvailableCombos;

	UPROPERTY(Category = "Combo", EditDefaultsOnly, BlueprintReadOnly)
	TObjectPtr<class UComboData> RelevantCombo;
