...
#include "ATAASC_Character.generated.h"

/**
 * 
 */
UCLASS()
class ATA_DREAMCOMETRUE_API UATAASC_Character : public UATAASC_Base
{
	GENERATED_BODY()
...
public:
	...
	static UATAASC_Character* TryGetCharacterAtaASCFromActor(const AActor* InActor, bool bInTryFindComponentIfNoInterface = true);
//~ End Statics
...
public:
	...
	TObjectPtr<class UATACMC_Base> OwnerCMC;
//~ End Components
