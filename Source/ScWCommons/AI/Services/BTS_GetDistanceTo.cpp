...
#include "AI/Services/BTS_GetDistanceTo.h"
...
//~ Begin Editor
#if WITH_EDITOR
void UBTS_GetDistanceTo::PostEditChangeProperty(FPropertyChangedEvent& InPropertyChangedEvent) // UObject
{
...
//~ Begin Service
void UBTS_GetDistanceTo::InitializeFromAsset(UBehaviorTree& InTreeAsset) // UBTNode
{
...
void UBTS_GetDistanceTo::TickNode(UBehaviorTreeComponent& InOwnerTree, uint8* InNodeMemory, float InDeltaSeconds) // UBTAuxiliaryNode
{
