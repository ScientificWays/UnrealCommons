...
//~ Begin Editor
#if WITH_EDITOR
void UBTD_CheckDistance::PostEditChangeProperty(FPropertyChangedEvent& InPropertyChangedEvent) // UObject
{
...
//~ Begin Decorator
FString UBTD_CheckDistance::GetStaticDescription() const // UBTNode
{
...
void UBTD_CheckDistance::InitializeFromAsset(UBehaviorTree& InTreeAsset) // UBTNode
{
...
bool UBTD_CheckDistance::CalculateRawConditionValue(UBehaviorTreeComponent& InOwnerTree, uint8* InNodeMemory) const // UBTDecorator
{
