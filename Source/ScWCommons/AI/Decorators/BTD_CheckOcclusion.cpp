...
#include "AI/Decorators/BTD_CheckOcclusion.h"

#include "AI/Types_AI.h"

#include "BehaviorTree/Blackboard/BlackboardKeyType_Vector.h"

UBTD_CheckOcclusion::UBTD_CheckOcclusion()
{
...
//~ Begin Decorator
FString UBTD_CheckOcclusion::GetStaticDescription() const // UBTNode
{
...
void UBTD_CheckOcclusion::InitializeFromAsset(UBehaviorTree& InTreeAsset) // UBTNode
{
...
bool UBTD_CheckOcclusion::CalculateRawConditionValue(UBehaviorTreeComponent& InOwnerTree, uint8* InNodeMemory) const // UBTDecorator
{
	if (!FromTargetKey.IsSet())
	{
