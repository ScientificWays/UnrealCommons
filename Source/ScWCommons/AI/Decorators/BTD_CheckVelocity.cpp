...
#include "AI/Decorators/BTD_CheckVelocity.h"

#include "AI/Types_AI.h"

UBTD_CheckVelocity::UBTD_CheckVelocity()
{
...
//~ Begin Decorator
void UBTD_CheckVelocity::InitializeFromAsset(UBehaviorTree& InTreeAsset) // UBTNode
{
...
bool UBTD_CheckVelocity::CalculateRawConditionValue(UBehaviorTreeComponent& InOwnerTree, uint8* InNodeMemory) const // UBTDecorator
{
